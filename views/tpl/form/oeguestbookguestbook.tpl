...
[{if $oxcmp_user}]
    [{if !$oView->floodProtection()}]
        ...
        <a id="writeNewReview" rel="nofollow"><b>[{oxmultilang ident="OEGUESTBOOK_CLICK_HERE_TO_WRITE_ENTRY"}]</b></a>
    [{/if}]
[{else}]
    <a href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=account" params="sourcecl="|cat:$oViewConf->getActiveClassName()|cat:$oViewConf->getNavUrlParams()}]" rel="nofollow"><b>[{oxmultilang ident="OEGUESTBOOK_MESSAGE_TO_BE_LOGGED_WRITE_GUESTBOOK"}]</b></a>
[{/if}]
